...
<div class="menu">
            <div class="back"><a style="color: white;" class="active" href="<?php echo base_url('user/user_profile'); ?>">Home</a></div>
            <td><div class="name" style="font-family: monospace;"><?php echo $this->session->userdata('user_email'); ?>
                <div></td>
                    </td><p></p></td>
                </div>
            </div>
...
<form method="POST" action ="<?php echo base_url('user/kirim');?>">
<td><input style="    border-radius: 5px;
    table-layout: fixed;
    height: 30px;" class="textarea" type="text" name="pesan"></td>
